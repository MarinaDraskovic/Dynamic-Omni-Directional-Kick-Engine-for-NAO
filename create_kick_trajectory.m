...
if ~kick_type
    P4 = [ball_position(1) - x_P, ball_radius, ball_position(3) - z_P]; % Height of the kicking point is in the middle of the ball - slow kick
elseif kick_type == 1
...
if ~kick_type
  ...
  P3 = [ball_position(1)-x_P, 0.0, ball_position(3)-z_P];
end
