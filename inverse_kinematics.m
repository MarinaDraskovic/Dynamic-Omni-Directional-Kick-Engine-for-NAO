...
if right_leg == 1 
    if hipRoll < -0.738274
        hipRoll = -0.738274;
    elseif hipRoll > 0.379435
        hipRoll = 0.379435;
    end
    
    if hipPitch < -1.535889
        hipPitch = -1.535889;
    elseif hipPitch > 0.48398
        hipPitch = 0.48398;
    end
    
    if kneePitch < -0.103083
        kneePitch = -0.103083;
    elseif kneePitch > 2.120198
        kneePitch = 2.120198;
    end
    
    if footPitch < -1.186448 
        footPitch = -1.186448;
    ...
    if kneePitch < -0.092346
        kneePitch = -0.092346;
    elseif kneePitch > 2.112528
        kneePitch = 2.112528;
    end
    
    if footPitch < -1.189516
        footPitch = -1.189516;
    elseif footPitch > 0.922581
        footPitch = 0.922581;
    end
